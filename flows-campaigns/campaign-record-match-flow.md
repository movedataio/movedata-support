...
**Flow Name:** MoveData\_Commerce\_Campaign\_Duplicate\
...
* Specifies `ObjectType` as "Campaign" for targeted lookup
...
* **MoveData Engine**: `Config_MoveDataEngine` supports version-specific processing behavior
