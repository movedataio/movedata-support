...
* `status`: Status of the catalog item (e.g., active, archived, draft).
* `type`: Type of the catalog item (e.g., ordinary, discount, feePlatform).
* `description`: Description of the catalog item.
* `imageUrl`: URL of the catalog item image.
...
* `modifiedAt`: Date when the catalog was last modified.
