...
| Option                                      | Description                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Processor Version                           | <ul><li>V1: Donation Only (default)<br>Processes all Raisely information except Orders</li><li>V2: Donation &#x26; Tickets<br>All V1 functionality plus Orders</li></ul>                                                                                                                                     |
| Fee Allocation Method                       | <p>Note: only available if Processor Version set to V2: Donation &#x26; Tickets</p><p></p><ul><li>Donation Only<br>Fee allocated to Donation record</li><li>Order Only (default)<br>Fee allocated to Order record</li><li>Split 50/50<br>Fee distributed evenly against Donation and Order records</li></ul> |
| Aggregate Order Line Items                  | <p>Note: only available if Processor Version set to V2: Donation &#x26; Tickets</p><p></p><ul><li>Retain Individual Order Lines (default)<br>Creates Opportunity Product for each ticket </li><li>Combine Where Product is the Same<br>Creates Opportunity Product for each ticket type</li></ul>            |
| Facebook as Standard Donations              | <ul><li>Offline Donation (default)<br>Treats Facebook Donations as Offline Donations</li><li>Once-Off Anonymous Donation<br>Treats Facebook Donations as Online Donations</li></ul>                                                                                                                          |
| Use Notification over Profile for Addresses | <ul><li>Prioritise User Profile Data (default)<br>Uses address from the Raisely Profile</li><li>Prioritise Notification Data<br>Uses address from the Raisely donation</li></ul>                                                                                                                             |
