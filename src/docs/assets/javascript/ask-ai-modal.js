...
function init() {
  ...
  askAiButton.title = 'Ask MoveData Assistant (Ctrl+K)';
  askAiButton.setAttribute('aria-label', 'Ask MoveData Assistant');
    ...
    <div class="ask-ai-modal__inner" role="dialog">
      <div class="ask-ai-modal__header">
        <h2 class="ask-ai-modal__title">
          <img src="/assets/logo.svg" alt="MoveData Logo" style="width: 52px; height: 52px; filter: invert(59%) sepia(73%) saturate(1837%) hue-rotate(163deg) brightness(97%) contrast(89%);" />
