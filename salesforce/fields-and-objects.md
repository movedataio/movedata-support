...
| Phone      | Phone field    | Primary phone number for the account | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| PersonEmail | Email field   | Email address for person accounts    | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| RecordTypeId | Lookup to RecordType | Record type identifier        | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
...
| Field Name        | Type           | Purpose                             | Source Flows                |
| ----------------- | -------------- | ----------------------------------- | --------------------------- |
| BillingStreet     | Textarea field | Street address for billing          | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| BillingCity       | Text field     | City for billing address            | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| BillingState      | Text field     | State/Province for billing address  | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| BillingCountry    | Text field     | Country for billing address         | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| BillingPostalCode | Text field     | Postal/ZIP code for billing address | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |

### Shipping Address Fields

| Field Name         | Type           | Purpose                              | Source Flows                |
| ------------------ | -------------- | ------------------------------------ | --------------------------- |
| ShippingStreet     | Textarea field | Street address for shipping          | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| ShippingCity       | Text field     | City for shipping address            | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| ShippingState      | Text field     | State/Province for shipping address  | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| ShippingCountry    | Text field     | Country for shipping address         | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| ShippingPostalCode | Text field     | Postal/ZIP code for shipping address | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
...
| Field Name                                 | Type       | Purpose                             | Source Flows              |
| ------------------------------------------ | ---------- | ----------------------------------- | ------------------------- |
| Platform Key (`movedata__Platform_Key__c`) | Text field | Stores external platform identifier | [Account Platform Key Flow](../flows-account/account-platform-key-flow.md), [Account Post-Upsert Flow](../flows-account/account-post-upsert-flow.md) |
...
| Field Name    | Type       | Purpose                                | Source Flows              |
| ------------- | ---------- | -------------------------------------- | ------------------------- |
| Id            | ID field   | Unique record type identifier          | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| DeveloperName | Text field | API name of the record type            | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
| SobjectType   | Text field | Object type the record type applies to | [Account Mapping Flow](../flows-account/account-mapping-flow.md) |
...
| FirstName  | Text field (40 characters max) | Contact's first name          | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| LastName   | Text field (80 characters max) | Contact's last name (required field) | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| Salutation | Picklist field | Contact's title/salutation (Mr., Ms., Dr., etc.) | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonBirthdate | Date field | Contact's birth date                | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonEmail | Email field   | Primary email address               | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| Phone      | Phone field (40 characters max) | Primary phone number         | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| RecordTypeId | Lookup to RecordType | Record type identifier        | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| AccountId  | Lookup to Account | Links contact to associated account | [Contact Post-Upsert Flow](../flows-contact/contact-post-upsert-flow.md) |

### Person Mailing Address Fields

| Field Name                | Type           | Purpose                             | Source Flows                |
| ------------------------- | -------------- | ----------------------------------- | --------------------------- |
| PersonMailingStreet       | Textarea field (255 characters max) | Street address for mailing | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonMailingCity         | Text field (40 characters max) | City for mailing address     | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonMailingState        | Text field (80 characters max) | State/Province for mailing address | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonMailingCountry      | Text field (80 characters max) | Country for mailing address | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonMailingPostalCode   | Text field (20 characters max) | Postal/ZIP code for mailing address | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |

### Person Other Address Fields

| Field Name              | Type           | Purpose                            | Source Flows                |
| ----------------------- | -------------- | ---------------------------------- | --------------------------- |
| PersonOtherStreet       | Textarea field (255 characters max) | Alternative street address | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonOtherCity         | Text field (40 characters max) | Alternative city address    | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonOtherState        | Text field (80 characters max) | Alternative state/province address | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonOtherCountry      | Text field (80 characters max) | Alternative country address | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
| PersonOtherPostalCode   | Text field (20 characters max) | Alternative postal/ZIP code | [Contact Mapping Flow](../flows-contact/contact-mapping-flow.md) |
...
| Field Name                                 | Type       | Purpose                             | Source Flows              |
| ------------------------------------------ | ---------- | ----------------------------------- | ------------------------- |
| Platform Key (`movedata__Platform_Key__c`) | Text field | Stores external platform identifier | [Contact Platform Key Flow](../flows-contact/contact-platform-key-flow.md), [Contact Post-Upsert Flow](../flows-contact/contact-post-upsert-flow.md) |
...
| Field Name | Type                  | Purpose                           | Source Flows              |
| ---------- | --------------------- | --------------------------------- | ------------------------- |
| Id         | ID field              | Unique relationship identifier    | [Contact Post-Upsert Flow](../flows-contact/contact-post-upsert-flow.md) |
| AccountId  | Lookup to Account     | Account side of the relationship  | [Contact Post-Upsert Flow](../flows-contact/contact-post-upsert-flow.md) |
| ContactId  | Lookup to Contact     | Contact side of the relationship  | [Contact Post-Upsert Flow](../flows-contact/contact-post-upsert-flow.md) |
| Roles      | Picklist field        | Business relationship role classification | [Contact Post-Upsert Flow](../flows-contact/contact-post-upsert-flow.md) |
...
| ParentId        | Lookup to Campaign             | Links to parent campaign for hierarchical campaign structures | [Campaign Mapping Flow](../flows-campaign/campaign-mapping-flow.md), [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
...
| Field Name | Type              | Purpose                               | Source Flows              |
| ---------- | ----------------- | ------------------------------------- | ------------------------- |
| Id         | ID field          | Unique campaign member identifier     | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| CampaignId | Lookup to Campaign | Links member to campaign             | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| ContactId  | Lookup to Contact | Links member to contact              | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| Status     | Picklist field    | Member status within the campaign    | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
...
| Field Name | Type              | Purpose                                | Source Flows              |
| ---------- | ----------------- | -------------------------------------- | ------------------------- |
| Id         | ID field          | Unique member status identifier        | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| CampaignId | Lookup to Campaign | Links status to campaign              | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| Label      | Text field        | Display name for the member status     | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| SortOrder  | Number field      | Determines display order of statuses   | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
| IsDefault  | Checkbox field    | Indicates if this is the default status | [Campaign Post-Upsert Flow](../flows-campaign/campaign-post-upsert-flow.md) |
...
| Field Name    | Type              | Purpose                                      | Source Flows                                |
| ------------- | ----------------- | -------------------------------------------- | ------------------------------------------- |
| Id            | ID field          | Unique record identifier                     | [Commerce Order Record Match Flow](../flows-commerce/commerce-order-record-match-flow.md), [Commerce Order Final Flow](../flows-commerce/commerce-order-final-flow.md) |
| Name          | Text field        | Order name identifier                        | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md), [Commerce Order Final Flow](../flows-commerce/commerce-order-final-flow.md) |
| Amount        | Currency field    | Total order amount                           | [Commerce Order Final Flow](../flows-commerce/commerce-order-final-flow.md) |
| AccountId     | Lookup to Account | Associated account for the order             | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md), [Commerce Order Final Flow](../flows-commerce/commerce-order-final-flow.md) |
| StageName     | Picklist field    | Current stage of the opportunity             | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md), [Commerce Order Final Flow](../flows-commerce/commerce-order-final-flow.md) |
| CloseDate     | Date field        | Order close/completion date                  | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| CampaignId    | Lookup to Campaign | Associated campaign for the order           | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Description   | Long Text Area field | Order description or notes                 | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Pricebook2Id  | Lookup to Pricebook2 | Associated pricebook for the order        | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| RecordTypeId  | Lookup to RecordType | Record type identifier                     | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| CurrencyIsoCode | Picklist field   | Currency code for the order                  | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |

### Custom Fields

| Field Name                                 | Type       | Purpose                                         | Source Flows              |
| ------------------------------------------ | ---------- | ----------------------------------------------- | ------------------------- |
| Platform Key (`movedata__Platform_Key__c`) | Text field | Stores external platform identifier for matching | [Commerce Order Record Match Flow](../flows-commerce/commerce-order-record-match-flow.md), [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |

### NPSP Extension Fields

| Field Name                                     | Type                  | Purpose                                    | Source Flows              |
| ---------------------------------------------- | --------------------- | ------------------------------------------ | ------------------------- |
| Primary Contact (`npsp__Primary_Contact__c`)  | Lookup to Contact     | Primary contact for the opportunity        | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |

### MoveData NPSP Extension Fields

| Field Name                                       | Type           | Purpose                                  | Source Flows              |
| ------------------------------------------------ | -------------- | ---------------------------------------- | ------------------------- |
| Fee (`md_npsp_pack__Fee__c`)                     | Currency field | Total fee amount                         | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Platform Fee (`md_npsp_pack__Platform_Fee__c`)  | Currency field | Platform fee amount                      | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Gateway Fee (`md_npsp_pack__Gateway_Fee__c`)    | Currency field | Gateway processing fee                   | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Tax (`md_npsp_pack__Tax__c`)                     | Currency field | Tax amount                               | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Platform Fee Tax (`md_npsp_pack__Platform_Fee_Tax__c`) | Currency field | Tax on platform fee               | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Gateway Fee Tax (`md_npsp_pack__Gateway_Fee_Tax__c`)   | Currency field | Tax on gateway fee                | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
| Receipt Number (`md_npsp_pack__Receipt_Number__c`)     | Text field     | Receipt identifier                | [Commerce Order Mapping Flow](../flows-commerce/commerce-order-mapping-flow.md) |
...
| Field Name        | Type                     | Purpose                                    | Source Flows                                |
| ----------------- | ------------------------ | ------------------------------------------ | ------------------------------------------- |
| Id                | ID field                 | Unique line item identifier                | [Commerce Order Item Record Match Flow](../flows-commerce/commerce-order-item-record-match-flow.md) |
| OpportunityId     | Lookup to Opportunity    | Links line item to order                   | [Commerce Order Item Mapping Flow](../flows-commerce/commerce-order-item-mapping-flow.md) |
| PricebookEntryId  | Lookup to PricebookEntry | Links to product pricing information       | [Commerce Order Item Mapping Flow](../flows-commerce/commerce-order-item-mapping-flow.md) |
| Quantity          | Number field             | Quantity of product ordered                | [Commerce Order Item Mapping Flow](../flows-commerce/commerce-order-item-mapping-flow.md) |
| UnitPrice         | Currency field           | Price per unit                             | [Commerce Order Item Mapping Flow](../flows-commerce/commerce-order-item-mapping-flow.md) |
| TotalPrice        | Currency field           | Total price for the line item              | [Commerce Order Item Mapping Flow](../flows-commerce/commerce-order-item-mapping-flow.md) |

### Custom Fields

| Field Name                        | Type       | Purpose                                         | Source Flows              |
| --------------------------------- | ---------- | ----------------------------------------------- | ------------------------- |
| Platform Key (`Platform_Key__c`) | Text field | Stores external platform identifier for matching | [Commerce Order Item Record Match Flow](../flows-commerce/commerce-order-item-record-match-flow.md), [Commerce Order Item Mapping Flow](../flows-commerce/commerce-order-item-mapping-flow.md) |
