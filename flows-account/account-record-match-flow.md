...
**Label:** \[MoveData] Donation: Account - Record Match\
**Type:** Auto-Launched Flow Template\
**API Version:** 60.0\
**Status:** Active

This flow performs duplicate detection for account records by using platform keys to identify existing account in Salesforce, enabling proper record matching and preventing duplicate creation.
...
* Checks the `movedata__Account_Platform_Key__c.movedata__Platform_Key__c` field for matches
...
* Searches Contact records by `movedata__Account_Platform_Key__c.movedata__Platform_Key__c` field
