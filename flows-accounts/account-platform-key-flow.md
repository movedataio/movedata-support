...
**Flow Name:** MoveData\_Commerce\_Account\_Key\
**Label:** \[MoveData] Commerce: Account - Platform Key\
...
* Provide consistent identification for accounts across different commerce platforms
...
**Example:** `eventbrite:customer123`
