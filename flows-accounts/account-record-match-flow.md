...
**Flow Name:** MoveData\_Commerce\_Account\_Duplicate\
**Label:** \[MoveData] Commerce: Account - Record Match\
**Type:** Auto-Launched Flow Template\
**API Version:** 60.0\
**Status:** Active

This flow performs duplicate detection for account records by using platform keys to identify existing accounts in Salesforce, enabling proper record matching and preventing duplicate creation during commerce processing.
