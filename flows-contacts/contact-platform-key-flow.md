...
**Flow Name:** MoveData\_Commerce\_Contact\_Key\
**Label:** \[MoveData] Commerce: Contact - Platform Key\
...
* Provide consistent identification for contacts across different commerce platforms
...
**Example:** `eventbrite:customer456`
