...
To view the polling attempts, navigate to the notifications tab within the MoveData application. Click the Filter icon on the top right on the list and set the criteria to `Type Equals Job` like the figure above.
