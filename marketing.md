...
* `content`: Specific content or ad variant identifier - equivalent to utm_content
* `term`: Search term or keyword that triggered the visit - equivalent to utm_term
* `url`: Full URL that brought the user to the site
* `referrer`: HTTP referrer URL from the previous page