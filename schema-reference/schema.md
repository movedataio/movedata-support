...
* `campaign`: \[[📖 Campaign](../related-entities/campaign.md)] An array of Campaign objects. Each campaign represents a fundraising effort associated with a donation or registration.
* `anonymous`: A boolean flag identifying if the donation is to be anonymous
* `donor`: \[[📖 Person](../related-entities/person.md) and [📖 Organisation](../related-entities/organisation.md)] Primary contact person or organization responsible for the donation
* `tribute`: \[[📖 Tribute](../related-entities/tribute.md)] A Tribute entry; used to identify a donation is in memory or tribute of someone
* `matched`: \[[📖 Matched](../related-entities/matched.md)] A Matched entry containing information about a matching donation
* `recurring`: \[[📖 Recurring](../related-entities/recurring.md)] A Recurring entry; identifies start date, amount, frequency around a recurring donation
* `donation`: \[[📖 Donation](../related-entities/donation.md)] A Donation entry containing dates, descriptions and financially-related information
...
* `questions`: \[[📖 Question](../related-entities/question.md)] An array of Question objects used to hold custom questions and answers
